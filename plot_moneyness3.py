...
ax1.fill_between(gc_moneyness, gc_abs_lo, gc_abs_hi, alpha=0.15, color='#B8860B')
ax1.plot(gc_moneyness, gc_abs, color='#B8860B', linewidth=1.4, marker='o', markersize=4, zorder=3)
...
ax2.fill_between(si_moneyness, si_abs_lo, si_abs_hi, alpha=0.15, color='#4A6FA5')
ax2.plot(si_moneyness, si_abs, color='#4A6FA5', linewidth=1.4, marker='o', markersize=4, zorder=3)
